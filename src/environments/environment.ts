...
export const environment = {
    ...
    ventasApiUrl: 'http://localhost:3008/api/v1/ventas/gestor_ventas/vendedores/planes-venta1',
    ...
    listaProductosApiUrl: 'http://localhost:3001/api/v2/inventario/gestor_productos/productos',
    listaZonasApiUrl: 'http://localhost:3001/api/v1/inventario/gestor_productos/zonas',
